...
- Verde como CTA é o padrão consolidado em plataformas de cursos — a Atama usa laranja (marca própria) para se diferenciar desse padrão genérico
...
- Verde similar ao que plataformas usam como padrão — a Atama se diferencia com laranja da própria marca (#FC7D35)
...
| **Paleta** | **Branco + laranja** | Dark marrom | Branco minimal | Branco ultra-minimal |
| **Oferta formativa** | Presencial + vivência + case study | Online gravado | — | — |
| **Preço** | Premium (turmas exclusivas) | Acesso online variável | — | — |

**Conclusão estratégica:** Fundo branco + visual autoral + laranja #FC7D35 (da própria marca) como accent nos diferencia de Barco (dark escolar) e de todas as plataformas de cursos que usam verde genérico. O design precisa comunicar: **"somos produtores que ensinam o que sabemos fazer de verdade"** — não uma escola de cursos online.
...
- Overlay laranja #FC7D35 60% opacidade sobre a foto — cria o laranja da marca como identidade do Lab
...
- CTA principal: botão branco sólido "Inscrever-se agora" abaixo do título (não laranja, porque o fundo já é laranja)
...
**Viabilidade real em 21 dias:** Com 1 tipografia (Roboto), 1 accent color (laranja #FC7D35), 5 componentes base e 7 páginas, é possível codificar com Next.js + Tailwind em 2 semanas com 1 semana de testes. Qualquer outro caminho compromete o deadline.

**KPI de conversão:** O branco com laranja como único accent maximiza o contraste do CTA do Lab. O olho não tem concorrência — vai direto para o botão laranja. Laranja #FC7D35 em fundo branco tem contraste ratio 3.2:1 (WCAG AA para textos grandes e componentes de UI) — adequado para botões de CTA com texto branco em Bold.
...
- Accent: Playfair para títulos, laranja #FC7D35 para CTAs de inscrição (consistente com a marca)
...
- Laranja #FC7D35 como cor primária, não só accent
...
A paleta é extraída diretamente do logo da Atama Filmes — garantindo que o site seja uma extensão natural da identidade da marca, não um sistema de cores separado.

| Token | Hex | Origem | Uso |
|---|---|---|---|
| Branco | #FFFFFF | — | Fundo principal de todas as páginas |
| Grafite Atama | #3A3A3A | Logo "atama" | Textos primários, headings, logo |
| Laranja Atama | #FC7D35 | Símbolo circular + "FILMES" | CTAs, botões primários, hover states, accent |
| Laranja hover | #E56B20 | Derivado (-15% luminosidade) | Estado hover dos botões |
| Laranja claro | #FFF0E6 | Derivado (tint 90%) | Fundo de seções do Lab, separação sutil |
...
> **Nota:** O laranja #FC7D35 substitui o verde genérico de plataformas de cursos. Isso diferencia a Atama de Hotmart, Skillshare e Domestika — que usam verde padrão — e mantém coerência total com a identidade da marca. O laranja quente transmite autoria, criatividade e calor humano — valores mais alinhados à Atama do que o verde frio de marketplace.
...
- **Primário:** Fundo laranja #FC7D35, texto branco, Roboto Medium 500 16px, altura 56px, radius 4px — para CTAs de inscrição e ações principais
- **Secundário:** Outline grafite #3A3A3A 2px, texto grafite, mesma tipografia — para ações alternativas
- **Terciário:** Texto puro com underline laranja no hover — para links de navegação contextual
- **Estados:** Default / Hover (#E56B20, escurece 15%) / Active / Focus (outline 3px laranja) / Disabled (50% opacity)
...
- Overlay: branco 20–30% para o Site / laranja #FC7D35 60% para o Lab
...
- Links à direita: Roboto Medium 14px, grafite #3A3A3A, hover com underline laranja #FC7D35
- Botão CTA laranja "Inscrever-se" no extremo direito (apenas nas páginas do Lab)
- Fixo no scroll: `position: sticky`, fundo branco 95% + sombra sutil ao scroll
- Mobile: hamburger icon (3 linhas) → menu lateral com links empilhados + botão CTA laranja 100%
...
Laranja #FC7D35 (extraído do símbolo do logo) confirma como CTA principal e accent do site e Lab?
...
| **Paleta** | Branco + Grafite #3A3A3A + Laranja #FC7D35 (marca) |
