...
name: handover
description: >
  Transfere contexto entre sessões de IA (Codex ↔ ChatGPT) via GitHub.
...
> **Objetivo:** Garantir continuidade de trabalho entre Codex e ChatGPT (ou qualquer outra IA) via GitHub, usando `.ai-context.md` como contrato de interface.
...
2. `.Codex/knowledge/business-context.md` — deadlines, KPIs, restrições
